...
showResult("目标","A","/webapp/temp/ct/data/A1/json/");
showResult("结果1","A","/webapp/temp/ct/data/A2/json/");
showResult("结果2","A","/webapp/temp/ct/data/A3/json/");
showResult("结果3","A","/webapp/temp/ct/data/A4/json/");
showResult("结果4","A","/webapp/temp/ct/data/A5/json/");
showResult("结果5","A","/webapp/temp/ct/data/A6/json/");
showResult("结果6","A","/webapp/temp/ct/data/A7/json/");

/*
//showResult("F目标","B","/webapp/temp/ct/data/B1/json/");
//showResult("F结果1","B","/webapp/temp/ct/data/B2/json/");
showResult("目标","B","/webapp/temp/ct/data/B3/json/");
showResult("结果1","B","/webapp/temp/ct/data/B4/json/");
//showResult("F结果4","B","/webapp/temp/ct/data/B5/json/");
showResult("结果2","B","/webapp/temp/ct/data/B6/json/");
showResult("结果3","B","/webapp/temp/ct/data/B7/json/");
